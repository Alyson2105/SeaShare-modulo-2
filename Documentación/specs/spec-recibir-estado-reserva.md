...
- **FR-006**: Cuando la reserva pase a estado `Completado` con sub-estado `Con incidentes`, el sistema DEBE notificar a Módulo 3 enviando los detalles y comentarios de las averías para que Módulo 3 retenga la garantía e inicie la revisión.
